class Game {
  ...
  constructor() {
    ...
    this.colors = ["#6062e7", "#e760d1", "#571770"]; // the 3 colors used in the game
  ...
  * Display score
   ...
   */
  showGrade(score) {
    if (score > 30) return "The BEST";else
    if (score > 25) return "Você é fenomenal";else
    if (score > 20) return "Incrivel";else
    if (score > 15) return "Muito bem!";else
    if (score > 13) return "bom!";else
    if (score > 10) return "Bom trabalho!";else
    if (score > 5) return "so isso?";else
...
class Color {
  ...
  constructor() {
    this.colors = ["#6062e7", "#e760d1", "#571770"];
  ...
  colorcodeToName(color) {
    let colors = ["#6062e7", "#e760d1", "#571770"];
